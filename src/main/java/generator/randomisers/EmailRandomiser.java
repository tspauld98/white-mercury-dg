...
public class EmailRandomiser implements IRandomiserFunctionality
{
    ...
    public void setRandomiserInstance(RandomiserInstance ri)
    {
        ...
        try
        {
            vTopDomains = utils.readResource("resources" + File.separator +"TLDs.txt");
            ...
            vProviders = utils.readResource("resources" + File.separator + "emailproviders.txt");
        }
        catch(Exception fnfe)
        {
            logger.error("A data file could not be loaded", fnfe);
        }
